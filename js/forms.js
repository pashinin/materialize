...
// const cc = new CharacterCounter();

// (function($) {
// Function to update labels of text fields
const updateTextFields = function() {
  let input_selector =
    'input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], input[type=date], input[type=time], textarea';
  $(input_selector).each(function(index, element) {
    let $this = $(this);
    // const cc = new CharacterCounter($this);
    // CharacterCounter.init(this);
    if (
...
const validate_field = function(object) {
  let hasLength = object.attr('data-length') !== null && object.attr('data-length') !== undefined;
...
const textareaAutoResize = function($textarea) {
...
$(document).ready(function() {
  ...
  $(document).on('change', input_selector, function() {
    if (
      this.value.length !== 0 ||
      ($(this).attr('placeholder') !== null && $(this).attr('placeholder') !== undefined)
    ) {
      $(this)
        .siblings()
        .filter('label')
  ...
  $(document).on('reset', function(e) {
    ...
    if (formReset.is('form')) {
      formReset
        ...
        .removeClass('valid')
        .removeClass('invalid');
      formReset.find(input_selector).each(function(ind, e) {
  ...
  document.addEventListener(
    ...
    function(e) {
      ...
      if ($inputElement.is(input_selector)) {
        ...
        // console.log($inputElement[0].value.length);
        if (
        ...
        // selector += ', label';
        // console.log($inputElement[0].validity.badInput);
        // console.log($inputElement.siblings(selector));
